####Generate data for figure 2a,figure3 main text and figure s5-s10 supp ############
rm(list=ls())
library(deSolve)
library(tidyverse)
library(rootSolve)
...
#############load mainmodel(baseline) output and plot chain####
load("Data/mainmod")
df_chain=mainmod$chain[10000:50000,]
...
#Save the data
save(predRC_yearlybase,file = "Data/predRC_yearlybase")


###################RC baseline overall main figure2a##############
...
#Save the data
save(predRC_allbase,file = "Data/predRC_allbase")
...
save(RC_mcv2aonly,file = "Data/RC_mcv2aonly")
...
save(RC_mcv2bonly,file = "Data/RC_mcv2bonly")
...
save(RC_mcv1mcv2a,file = "Data/RC_mcv1mcv2a")
...
save(RC_mcv1mcv2b,file = "Data/RC_mcv1mcv2b")
...
save(RC_mcv1mcv2c,file = "Data/RC_mcv1mcv2c")
...
save(RC_newbase,file = "Data/RC_newbase")
...
save(RC_newbase2,file = "Data/RC_newbase2")
...
save(RC_newbase3,file = "Data/RC_newbase3")
